...
//    //某些路径不拦截
//    public static final String[] IGNORE_URI = {"/wxService/getUserMessage","/wxService/createMenu","/wxService/validate","/static", "/account/modify_validate", "/account/register", "/account/login", "/js", "/images", "/css", "/account/validataAccount", "/account/index"};
//
//    @Override
